<template>
  <div class="game_card_list">
    <div  v-if="gameToExchange !== null" class="game_card">
      ...
      <a @click="resetToExchangeSelected()" title="arrow icons" class="icon">
        <img class="icon"
    ...
    <div v-if="gameWish !== null" class="game_card">
      ...
      <a  @click="resetWishSelected()" title="arrow icons" class="icon">
        <img class="icon"
        src="../../assets/icones/delete.png"
        alt="Grapefruit slice atop a pile of other slices">
        </a>
...
export default {
  ...
  inject: ['resetToExchangeSelected', 'resetWishSelected'],
};
</script>
